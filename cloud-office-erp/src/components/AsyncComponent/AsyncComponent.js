...
/*
const AsyncMaterialRequisitionComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/material-requisition/MaterialRequisition"
    ),
  loading: () => <RctPageLoader />
});
*/

const AsyncAddPurchaseRequisitionInfoComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/material-requisition/AddPurchaseRequisitionInfo"
    ),
  loading: () => <RctPageLoader />
});

const AsyncAllMaterialRequisitionComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/material-requisition/AllMaterialRequisition"
    ),
  loading: () => <RctPageLoader />
});

// Purchase Order
const AsyncAddPurchaseOrderComponent = Loadable({
  loader: () =>
    import("Routes/cloud-office/inventory/PurchaseOrder/AddPurchaseOrder"),
  loading: () => <RctPageLoader />
});

const AsyncAllPurchaseOrdersComponent = Loadable({
  loader: () =>
    import("Routes/cloud-office/inventory/PurchaseOrder/AllPurchaseOrders"),
  loading: () => <RctPageLoader />
});

// Material Qc
const AsyncAddMaterialQcComponent = Loadable({
  loader: () =>
    import("Routes/cloud-office/inventory/material-qc/AddMaterialQc"),
  loading: () => <RctPageLoader />
});

const AsyncAllMaterialQcComponent = Loadable({
  loader: () =>
    import("Routes/cloud-office/inventory/material-qc/AllMaterialQc"),
  loading: () => <RctPageLoader />
});

// Material Issue Note
const AsyncAddMaterialIssueNoteComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/material-issue-note/AddMaterialIssueNote"
    ),
  loading: () => <RctPageLoader />
});

const AsyncAllMaterialIssueNoteComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/material-issue-note/AllMaterialIssueNote"
    ),
  loading: () => <RctPageLoader />
});

const AsyncAddIncomingMaterialComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/incoming-material/AddIncomingMaterial"
    ),
  loading: () => <RctPageLoader />
});

const AsyncAllIncomingMaterialComponent = Loadable({
  loader: () =>
    import(
      "Routes/cloud-office/inventory/incoming-material/AllIncomingMaterial"
    ),
  loading: () => <RctPageLoader />
});
...
export {
  ...
  //AsyncMaterialRequisitionComponent,
